...
struct MiotySpec {
    ...
    // B_c = CARRIER_SPACING_HZ / RFM69_FREQ_STEP_HZ = 2380.371 / 61.03515625 = 39
...
/**
 * @brief US0 Profile - Single channel at 915.6 MHz
 * 
 * - Center Frequency: 915.600 MHz
...
struct US0_Profile {
    // Frequencies in Hz (hardware-independent)
    static constexpr uint32_t FREQ_CH_A_HZ = 915600000;  // 915.600 MHz
    static constexpr uint32_t FREQ_CH_B_HZ = 915600000;  // Same as A (single channel)
...
/**
 * @brief IN0 Profile - Single channel at 865.6 MHz
 * 
 * - Center Frequency: 865.600 MHz
 * - Channel Bandwidth: 100 kHz
 * - Max Power: +30 dBm EIRP
 * - No duty cycle limit
 */
struct IN0_Profile {
    // Frequencies in Hz (hardware-independent)
    static constexpr uint32_t FREQ_CH_A_HZ = 865600000;  // 865.600 MHz
    static constexpr uint32_t FREQ_CH_B_HZ = 865600000;  // Same as A (single channel)
