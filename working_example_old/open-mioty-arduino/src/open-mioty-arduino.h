...
open-mioty-arduino - Open-source mioty® protocol library for Arduino

⚠️ IMPORTANT DISCLAIMERS - READ BEFORE USE ⚠️

THIS IS A THIRD-PARTY EDUCATIONAL PROJECT - NOT PRODUCTION SOFTWARE

Status:
  • Open-source, non-commercial educational project
...
/**
 * @mainpage open-mioty-arduino Library
 * 
 * @section intro Introduction
 * 
 * open-mioty-arduino implements the ETSI TS 103 357 TS-UNB standard (mioty®)
 ...
 * Commercial use requires patent licenses from Sisvel International S.A.
 * This is an open-source educational project, NOT production software.
 ...
 * 
 * @file open-mioty-arduino.h
 */

#ifndef OPEN_MIOTY_ARDUINO_H_
#define OPEN_MIOTY_ARDUINO_H_

// Version information
#define OPEN_MIOTY_ARDUINO_VERSION "0.1.0"
#define OPEN_MIOTY_ARDUINO_VERSION_MAJOR 0
#define OPEN_MIOTY_ARDUINO_VERSION_MINOR 1
#define OPEN_MIOTY_ARDUINO_VERSION_PATCH 0
